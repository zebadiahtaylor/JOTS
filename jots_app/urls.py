...
urlpatterns = [
    ...
    path('guide', views.about, name='guide'),
    ...
    path('article_add_note/<int:article_id>/<int:note_id>', views.article_append_note, name='article_add_note'),
    ...
    path('collection_complete/<int:collection_id>', views.collection_complete, name='collection_complete'),
    path('collection_find', views.collection_find, name='collection_find'),
    path('collection_request/<int:collection_id>', views.collection_request, name='collection_request'),
    ...
    # path('accept_group_invite/<uidb64>/<token>/', views.accept_group_invite, name='accept_group_invite'),
]